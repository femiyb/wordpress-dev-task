...
function findFirstEnabledItemInTheLastRow(items) {
  return _RV3PHHWMcjs.findFirstEnabledItem.call(void 0, 
    _array.flatten2DArray.call(void 0, _array.reverseArray.call(void 0, _RV3PHHWMcjs.groupItemsByRows.call(void 0, items)))
  );
}
function useScheduleFocus(store) {
  ...
  const activeItem = store.useState(
    (state) => _RV3PHHWMcjs.getEnabledItem.call(void 0, store, state.activeId)
  );
...
var useComposite = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    ...
    _react.useEffect.call(void 0, () => {
      ...
      const itemElement = (_a2 = _RV3PHHWMcjs.getEnabledItem.call(void 0, store, activeId2)) == null ? void 0 : _a2.element;
      if (!itemElement)
        return;
    ...
    _EO6LS72Hcjs.useSafeLayoutEffect.call(void 0, () => {
      ...
      if (!previousElement)
        return;
      const activeElement = (_a2 = _RV3PHHWMcjs.getEnabledItem.call(void 0, store, activeId)) == null ? void 0 : _a2.element;
    ...
    const onFocusCapture = _EO6LS72Hcjs.useEvent.call(void 0, (event) => {
      ...
      const isSilentlyFocused = _RV3PHHWMcjs.silentlyFocused.call(void 0, event.currentTarget);
    ...
    const onFocus = _EO6LS72Hcjs.useEvent.call(void 0, (event) => {
      ...
      const { virtualFocus: virtualFocus2 } = store.getState();
      if (virtualFocus2) {
        if (_events.isSelfTarget.call(void 0, event) && !_RV3PHHWMcjs.isItem.call(void 0, store, relatedTarget)) {
    ...
    const onBlurCapture = _EO6LS72Hcjs.useEvent.call(void 0, (event) => {
      ...
      if (!virtualFocus2)
        return;
      const activeElement = (_a2 = _RV3PHHWMcjs.getEnabledItem.call(void 0, store, activeId2)) == null ? void 0 : _a2.element;
      const nextActiveElement = event.relatedTarget;
      const nextActiveElementIsItem = _RV3PHHWMcjs.isItem.call(void 0, store, nextActiveElement);
      const previousElement = previousElementRef.current;
      previousElementRef.current = null;
      if (_events.isSelfTarget.call(void 0, event) && nextActiveElementIsItem) {
        ...
        const targetIsItem = _RV3PHHWMcjs.isItem.call(void 0, store, event.target);
    ...
    const onKeyDown = _EO6LS72Hcjs.useEvent.call(void 0, (event) => {
      ...
      const activeItem = _RV3PHHWMcjs.getEnabledItem.call(void 0, store, activeId2);
    ...
    const activeDescendant = store.useState((state) => {
      ...
      if (!state.virtualFocus)
        return;
      return (_a2 = _RV3PHHWMcjs.getEnabledItem.call(void 0, store, state.activeId)) == null ? void 0 : _a2.id;
    });
