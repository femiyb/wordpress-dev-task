...
var useCompositeItem = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    ...
    const rowId = _OALXXRFMcjs.useStoreState.call(void 0, store, (state) => {
      if (rowIdProp)
        return rowIdProp;
      if (!state)
        return;
    ...
    const baseElement = _OALXXRFMcjs.useStoreState.call(void 0, 
      store,
    ...
    const isActiveItem = _OALXXRFMcjs.useStoreState.call(void 0, 
      store,
      (state) => !!state && state.activeId === id
    );
    const virtualFocus = _OALXXRFMcjs.useStoreState.call(void 0, store, "virtualFocus");
    ...
    const ariaSetSize = _OALXXRFMcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const ariaPosInSet = _OALXXRFMcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const isTabbable = _OALXXRFMcjs.useStoreState.call(void 0, store, (state) => {
