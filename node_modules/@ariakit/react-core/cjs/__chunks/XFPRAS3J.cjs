...
var _5ZOCN23Xcjs = require('./5ZOCN23X.cjs');


var _JVDUGICDcjs = require('./JVDUGICD.cjs');
...
var useDialog = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store: storeProp,
      open: openProp,
    ...
    props = _EO6LS72Hcjs.useWrapElement.call(void 0, props, wrapElement, [wrapElement]);
    ...
    _EO6LS72Hcjs.useSafeLayoutEffect.call(void 0, () => {
      ...
      if (!canTakeTreeSnapshot)
        return;
      const dialog = ref.current;
      return _5GTNIPQ6cjs.createWalkTreeSnapshot.call(void 0, id, [dialog]);
    }, [id, canTakeTreeSnapshot]);
    const getPersistentElementsProp = _EO6LS72Hcjs.useEvent.call(void 0, getPersistentElements);
    _EO6LS72Hcjs.useSafeLayoutEffect.call(void 0, () => {
      if (!id)
        return;
      if (!canTakeTreeSnapshot)
    ...
    const autoFocusOnShowProp = _EO6LS72Hcjs.useBooleanEvent.call(void 0, autoFocusOnShow);
    ...
    const autoFocusOnHideProp = _EO6LS72Hcjs.useBooleanEvent.call(void 0, autoFocusOnHide);
    ...
    const hideOnEscapeProp = _EO6LS72Hcjs.useBooleanEvent.call(void 0, hideOnEscape);
    _react.useEffect.call(void 0, () => {
      if (!domReady)
        return;
      if (!mounted)
      ...
      const onKeyDown = (event) => {
        ...
        if (!dialog)
          return;
        if (_VV6WA3I6cjs.isElementMarked.call(void 0, dialog))
          return;
    ...
    props = _EO6LS72Hcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _J3OG6T3Bcjs.HeadingLevel, { level: modal ? 1 : void 0, children: element }),
      [modal]
    );
    ...
    props = _EO6LS72Hcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _F2A2ZQDBcjs.DialogScopedContextProvider, { value: store, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _F2A2ZQDBcjs.DialogHeadingContext.Provider, { value: setHeadingId, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _F2A2ZQDBcjs.DialogDescriptionContext.Provider, { value: setDescriptionId, children: element }) }) }),
      [store]
    );
...
function createDialogComponent(Component, useProviderContext = _F2A2ZQDBcjs.useDialogProviderContext) {
  return _RNZNGEL4cjs.createComponent.call(void 0, (props) => {
    ...
    if (!mounted)
      return null;
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Component, _AV6KTKLEcjs.__spreadValues.call(void 0, {}, props));
  });
}
var Dialog = createDialogComponent(
  ...
  _F2A2ZQDBcjs.useDialogProviderContext
);
if (process.env.NODE_ENV !== "production") {
