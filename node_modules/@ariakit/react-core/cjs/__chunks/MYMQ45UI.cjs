...
var _UL7JVGEUcjs = require('./UL7JVGEU.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _UL7JVGEUcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
    if (itemId === id)
      return true;
    const object = getItemObject(item);
...
function useCompositeRenderer(_a) {
  ...
  store = store || context;
  const orientation = _OALXXRFMcjs.useStoreState.call(void 0, 
    store,
  ...
  const items = _OALXXRFMcjs.useStoreState.call(void 0, store, (state) => {
    var _a2;
    if (!state)
      return props.items;
  ...
  const activeId = _OALXXRFMcjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _UL7JVGEUcjs.useCollectionRenderer.call(void 0, _AV6KTKLEcjs.__spreadProps.call(void 0, _AV6KTKLEcjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
