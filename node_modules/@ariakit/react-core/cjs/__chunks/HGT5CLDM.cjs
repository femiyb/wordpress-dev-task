...
var useRadio = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    ...
    const isChecked = _OALXXRFMcjs.useStoreState.call(void 0, 
      store,
    ...
    props = _P43G7USHcjs.useCompositeItem.call(void 0, _AV6KTKLEcjs.__spreadValues.call(void 0, { store, clickOnEnter: !nativeRadio }, props));
