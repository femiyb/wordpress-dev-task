...
var useTab = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
    ...
    const context = _I65V32V2cjs.useTabScopedContext.call(void 0, );
    store = store || context;
    _misc.invariant.call(void 0, 
      store,
      process.env.NODE_ENV !== "production" && "Tab must be wrapped in a TabList component."
    );
    const defaultId = _EO6LS72Hcjs.useId.call(void 0, );
    const id = props.id || defaultId;
    const dimmed = _misc.disabledFromProps.call(void 0, props);
    const getItem = _react.useCallback.call(void 0, 
      (item) => {
        const nextItem = _AV6KTKLEcjs.__spreadProps.call(void 0, _AV6KTKLEcjs.__spreadValues.call(void 0, {}, item), { dimmed });
        if (getItemProp) {
...
var Tab = _RNZNGEL4cjs.createMemoComponent.call(void 0, (props) => {
