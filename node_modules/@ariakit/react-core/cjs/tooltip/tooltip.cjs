...
var useTooltip = _RNZNGEL4cjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      portal = true,
    ...
    props = _EO6LS72Hcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _M5JJ43ATcjs.TooltipScopedContextProvider, { value: store, children: element }),
      [store]
    );
