...
function createFormStore(props = {}) {
  ...
  const form = _FJSZTIOUcjs.createStore.call(void 0, initialState, collection, props.store);
  ...
  const callbacks = _FJSZTIOUcjs.createStore.call(void 0, callbacksInitialState, syncCallbacks);
  _FJSZTIOUcjs.setup.call(void 0, form, () => _FJSZTIOUcjs.init.call(void 0, callbacks));
