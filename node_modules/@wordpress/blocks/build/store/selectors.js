...
const getBlockSupport = (state, nameOrType, feature, defaultSupports) => {
  ...
  return (0, _utils.getValueFromObjectPath)(blockType.supports, feature, defaultSupports);
};
...
function isMatchingSearchTerm(state, nameOrType, searchTerm) {
  const blockType = getNormalizedBlockType(state, nameOrType);
  const getNormalizedSearchTerm = (0, _compose.pipe)([
  // Disregard diacritics.
  //  Input: "média"
  term => (0, _removeAccents.default)(term !== null && term !== void 0 ? term : ''),
  // Lowercase.
  //  Input: "MEDIA"
