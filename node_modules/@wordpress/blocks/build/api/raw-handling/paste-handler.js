...
function filterInlineHTML(HTML) {
  HTML = (0, _utils.deepFilterHTML)(HTML, [_headRemover.default, _googleDocsUidRemover.default, _msListIgnore.default, _phrasingContentReducer.default, _commentRemover.default]);
...
function pasteHandler({
  ...
  HTML = (0, _utils.deepFilterHTML)(HTML, [_slackParagraphCorrector.default]);

  // Consider plain text if:
  // * There is a plain text version.
  // * There is no HTML version, or it has no formatting.
  const isPlainText = plainText && (!HTML || (0, _utils.isPlain)(HTML));
  ...
  const blocks = pieces.map(piece => {
    ...
    piece = (0, _utils.deepFilterHTML)(piece, [_htmlFormattingRemover.default, _brRemover.default, _emptyParagraphRemover.default], blockContentSchema);
