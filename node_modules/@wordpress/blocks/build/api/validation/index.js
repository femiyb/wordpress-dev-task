 ...
 */
function isEquivalentTextTokens(actual, expected, logger = (0, _logger.createLogger)()) {
...
function isEqualTagAttributePairs(actual, expected, logger = (0, _logger.createLogger)()) {
...
const isEqualTokensOfType = {
  StartTag: (actual, expected, logger = (0, _logger.createLogger)()) => {
 ...
 */
function getHTMLTokens(html, logger = (0, _logger.createLogger)()) {
  try {
 ...
 */
function isEquivalentHTML(actual, expected, logger = (0, _logger.createLogger)()) {
...
function validateBlock(block, blockTypeOrName = block.name) {
  const isFallbackBlock = block.name === (0, _registration.getFreeformContentHandlerName)() || block.name === (0, _registration.getUnregisteredTypeHandlerName)();
